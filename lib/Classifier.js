...
Classifier.prototype.load = function(filename, callback, elementClass) {
  fs.readFile(filename, 'utf8', function(err, data) {
    ...
    if(!err) {
        ...
        classifierData.sample.elements.forEach(function(elementData) {
          var elt = new elementClass(elementData.a, new Context(elementData.b));
...
Classifier.prototype.classify = function(b) {
  ...
  var min = sortable[sortable.length - 1][1];
